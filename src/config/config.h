...
#define MCU_FLASH_SIZE_ADDRESS  0x1FFF7A22
  ...
  #define FREERTOS_HEAP_SIZE      75000
#endif
#define FREERTOS_MIN_STACK_SIZE 200       // M4-FPU register setup is bigger so stack needs to be bigger
...
#define ADHOC_DECK_RX_TASK_NAME "ADHOC_RX"
...
#define NRF24LINK_TASK_STACKSIZE      (3*configMINIMAL_STACK_SIZE)
...
#define CRTP_SRV_TASK_STACKSIZE       (2 * configMINIMAL_STACK_SIZE)
