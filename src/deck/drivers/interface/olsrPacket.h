...
#define TS_PAYLOAD_MAX_NUM ((MESSAGE_PAYLOAD_MAX_SIZE-sizeof(olsrTsMessageHeader_t)))/sizeof(olsrTsMessageUnit_t)
...
typedef struct {
  ...
  olsrTsMessageUnit_t m_content[TS_PAYLOAD_MAX_NUM];
