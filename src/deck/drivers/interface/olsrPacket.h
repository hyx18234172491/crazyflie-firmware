...
#define TS_PAYLOAD_MAX_NUM ((MESSAGE_PAYLOAD_MAX_SIZE-sizeof(olsrTsMessageHeader_t)))/sizeof(olsrTimestampMessageUnit_t)
...
typedef struct {
  ...
  olsrTimestampMessageUnit_t m_content[TS_PAYLOAD_MAX_NUM];
