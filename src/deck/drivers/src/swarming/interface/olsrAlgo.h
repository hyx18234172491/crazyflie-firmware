...
#define TS_INTERVAL 50  //must be in range: 20 - 500
#define TS_INTERVAL_WINDOW_SIZE 0 // TS_INTERVAL + rand() % (TS_INTERVAL_WINDOW_SIZE / 2)
#define TS_INTERVAL_MIN 20 //default 20
#define TS_INTERVAL_MAX 200 //default 500
#define TS_ADDR_MAX 9
#define TS_OTSPOOL_MAXSIZE 100
