...
LOG_ADD(LOG_INT16, distTo3, distanceTowards + 4)
LOG_ADD(LOG_FLOAT, truthDistTo3, distanceReal+ 4)
LOG_ADD(LOG_INT16, distTo3, distanceTowards + 5)
LOG_ADD(LOG_FLOAT, truthDistTo3, distanceReal+ 5)
LOG_ADD(LOG_INT16, distTo3, distanceTowards + 6)
LOG_ADD(LOG_FLOAT, truthDistTo3, distanceReal+ 6)
LOG_ADD(LOG_INT16, distTo3, distanceTowards + 7)
LOG_ADD(LOG_FLOAT, truthDistTo3, distanceReal+ 7)
LOG_ADD(LOG_INT16, distTo3, distanceTowards + 8)
LOG_ADD(LOG_FLOAT, truthDistTo3, distanceReal+ 8)
